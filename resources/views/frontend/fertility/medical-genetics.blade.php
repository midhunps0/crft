...
<section class="w-full mt-10 mb-20">
    <x-header-sub>Medical Genetics</x-header-sub>
</section>
<section class="w-full flex flex-col justify-start items-start lg:mx-20">

    <h3 class="font-medium text-2xl mb-2">PGS</h3>
    <img src="{{ asset('images/medical-genetics/pgs.jpg')}}" alt="" class="w-full ltr:lg:pr-40 rtl:lg:pl-40 my-8">
    ...
    <h3 class="font-medium text-2xl my-4">PGD</h3>
    <img src="{{ asset('images/medical-genetics/pgd.jpg')}}" alt="" class="w-full ltr:lg:pr-40 rtl:lg:pl-40 my-8">
    <p class="text-justify leading-8 ltr:lg:mr-40 rtl:lg:ml-40">
    ...
    <h3 class="font-medium text-2xl my-4">Achondroplasia</h3>
    <img src="{{ asset('images/medical-genetics/baby.webp')}}" alt="" class="w-full ltr:lg:pr-40 rtl:lg:pl-40 my-8">
    <p class="text-justify leading-8 ltr:lg:mr-40 rtl:lg:ml-40">
    ...
    <h3 class="font-medium text-2xl my-4">Tay-sach's</h3>
    <img src="{{ asset('images/medical-genetics/baby-girl.webp')}}" alt="" class="w-full ltr:lg:pr-40 rtl:lg:pl-40 my-8">
    <p class="text-justify leading-8 ltr:lg:mr-40 rtl:lg:ml-40">
    ...
    <h3 class="font-medium text-2xl my-4">Medical Genetics</h3>
    <img src="{{ asset('images/medical-genetics/dna.jpg')}}" alt="" class="w-full ltr:lg:pr-40 rtl:lg:pl-40 my-8">
    <p class="text-justify leading-8 ltr:lg:mr-40 rtl:lg:ml-40">
    ...
    <p class="text-justify leading-8 ltr:lg:mr-40 rtl:lg:ml-40">The doctors say genetic disorders are often indicative via signs such as recurrent IVF failures and recurrent pregnancy loss. Some of the indicative factors are:Advanced maternal age</p>
    <ul class="flex flex-col">
        <li class="list-disc">Family history of any genetic disorders such as Spino-muscular dystrophy, Skeletal abnormalities</li>
        <li class="list-disc">Chromosomal abnormalities such as Mongolism</li>
        <li class="list-disc">Sex chromosomal related disorders</li>
        <li class="list-disc">Fragile X syndrome</li>
    </ul>
    <p class="text-justify leading-8 ltr:lg:mr-40 rtl:lg:ml-40">
    ...
    <h3 class="font-medium text-2xl my-4">Exclusive facilities at CRAFT</h3>
    <img src="{{ asset('images/medical-genetics/baby-mother.webp')}}" alt="" class="w-full ltr:lg:pr-40 rtl:lg:pl-40 my-8">
    <p class="text-justify leading-8 ltr:lg:mr-40 rtl:lg:ml-40">
    ...
    <h3 class="font-medium text-2xl my-4">Endometrial Receptor Assay (ERA)</h3>
    <img src="{{ asset('images/medical-genetics/egg.jpg')}}" alt="" class="w-full ltr:lg:pr-40 rtl:lg:pl-40 my-8">
    <p class="text-justify leading-8 ltr:lg:mr-40 rtl:lg:ml-40">
    ...
    <span class="font-medium my-2">Genetic Counseling which is again a service exclusive to CRAFT at two levels</span>
    <ul class="text-justify leading-8 ltr:lg:mr-40 rtl:lg:ml-40 ltr:ml-4 rtl:mr-4">
    <li class="mb-2">A. Genetic counseling is offered to detect risk estimation in couples and their families, family tree construction, Carrier Risk estimation for couples with a family history of genetic disorders, recurrent abortions, Repeated IVF Failures and abnormal ultrasound findings.</li>
    <li class="mb-2">B. Premarital Genetic Counselling exclusively for Sex related genetic diseases.</li>
    </ul>
    <p class="text-justify leading-8 ltr:lg:mr-40 rtl:lg:ml-40">
    ...
    <a href="" class="my-4 underline"> View more details </a>
    <div class="mx-auto mt-10 mb-20">
        <x-doctor img='images/medical-genetics/rithu.jpg' name='Dr Ritu Nair' designation='Chief Geneticist MSc. MS (UK), PhD' />
